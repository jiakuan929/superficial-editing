...
def main():
    ...
    aa("--output_dir", default="analysis_results/{model_name}/causal_trace")
...
class ModelAndTokenizer:
    ...
    def __init__(
        ...
        if 'gpt' in model.config._name_or_path.lower():
            assert self.num_layers == model.config.n_layer
        elif 'llama' in model.config._name_or_path.lower():
            assert self.num_layers == model.config.num_hidden_layers
