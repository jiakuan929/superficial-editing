...
def execute_rome(
    ...
    if request["target_new"]["str"][0] != " " and "llama-2" not in model.config._name_or_path.lower():
        # Space required for correct tokenization
        # Llama-2 tokenizer will add 29871 before the target token if we add a space at the start.
