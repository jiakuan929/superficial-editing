...
def layer_stats(
    ...
    # Customization for openpai
    if "usercache" in model_name:
        # !!!!!! Run on OpenPAI, we should modify the filename
        file_extension = file_extension.replace("usercache", "publiccache")
